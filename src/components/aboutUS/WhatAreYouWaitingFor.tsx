      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-4 flex flex-col justify-center space-y-6">
            <span className="text-primary font-alex text-4xl">
              Worauf wartest du?
            </span>
            ...
            <p className="text-gray-700 leading-relaxed">
              Entdecke, was StaysVerwaltung für Eigentümer und Urlauber so
              besonders macht. Vom persönlichen Service bis zur perfekten
              Ferienwohnung am Bodensee oder im Allgäu – hier beginnt dein
              Erlebnis.
            </p>
          </div>
