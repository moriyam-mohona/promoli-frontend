...
// const GoodToKnow = () => {
//   return (
//     <div className="bg-primary/20 py-20 relative">
...
//               className="font-outfit text-2xl font-semibold mb-4"
//             >
...
//             className="absolute top-20 right-10 transform -translate-x-1/2 -translate-y-1/2 flex-shrink-0"
//           >
